...
const complaintSchema = new mongoose.Schema({
  ...
  resolutionDate: { type: Date }, // New field
});
...
app.post('/api/complaints', upload.single('image'), async (req, res) => {
  try {
      const { name, address, contact, email, description, status, resolutionDate } = req.body;
      ...
      const complaint = new Complaint({
          ...
          resolutionDate: resolutionDate || null, // Optional
      });
      await complaint.save();

      io.emit('newComplaint', complaint); // Notify clients
...
app.patch('/api/complaints/:id', async (req, res) => {
  try {
      ...
      io.emit('updateComplaint', updatedComplaint); // Notify clients
